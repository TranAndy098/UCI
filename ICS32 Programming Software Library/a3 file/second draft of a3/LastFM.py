...
class LastFM:
    ...
    def transclude(self, message:str) -> str:
        ...
        '''
        replacements = {'@lastfm':self.lastfm,'@lastfm_top_5artists':self.top_5artists,'@lastfm_top_5tracks':self.top_5tracks,'@lastfm_top_5albums':self.top_5albums,'@lastfm_top_5tags':self.top_5tags}
