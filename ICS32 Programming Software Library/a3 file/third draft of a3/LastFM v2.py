...
class LastFM:
    ...
    def transclude(self, message:str) -> str:
        ...
        '''
        replacements = {'@lastfm':self.lastfm,'@lastfm.top_5artists':self.top_5artists,'@lastfm.top_5tracks':self.top_5tracks,'@lastfm.top_5albums':self.top_5albums,'@lastfm.top_5tags':self.top_5tags}
