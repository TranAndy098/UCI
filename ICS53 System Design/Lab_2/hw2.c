...
pid_t pid = 0; // global pid for handlers
...
char directory[100]; // instantiate working directory string for current directory
...
void executing(char *token, char *input_file_name, char *output_file_name, bool inputting, bool outputting, bool appending) 
{
    ...
    int amount = 0; // variable used to keep track of amount of args
